...
local bar_font = "JetBrainsMono Nerd Font:size=12"
...
oxwm.rule.add({ instance = "gimp", floating = true })                             
 oxwm.rule.add({ class = "Thunar", title = "Open File...", floating = true })  
oxwm.rule.add({ instance = "discord", floating = true })                      
...
oxwm.bar.set_scheme_selected(colors.cyan, colors.bg, colors.blue)
...
oxwm.key.bind({ modkey }, "R", oxwm.spawn({ "sh", "-c", "alacritty -e vifm" }))
-- Launch Dmenu
...
-- Uncomment and modify these examples, or add your own
 ...
 oxwm.autostart("picom --config $HOME/.config/picom.conf")                                  
