...
run_once({ "unclutter -root" , "sxhkd -c ~/.config/awesome/sxhkdrc --root" }) -- entries must be comma-separated
-- }}}
...
globalkeys = my_table.join(
    ...
    --awful.key({ modkey, }, "z", function () awful.util.spawn(dropdown_terminal) end,
      --        {description = "dropdown_terminal", group = "launcher"}),
