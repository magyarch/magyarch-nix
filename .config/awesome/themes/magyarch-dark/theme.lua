...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/magyarch-dark/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/magyarch-dark/wall.jpg"
...
local calbg = wibox.container.background(mytextcalendar, theme.font, "#c3cdc8", gears.shape.rectangle)
...
local barcolor  = gears.color({
    ...
    from  = { dpi(32), 0 },
    to    = { dpi(32), dpi(32) },
    stops = { {0, theme.bg_focus}, {0.25, "#282a36"}, {1, theme.bg_focus} }
})
